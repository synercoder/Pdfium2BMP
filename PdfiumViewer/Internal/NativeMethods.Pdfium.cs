...
namespace PdfiumViewer.Internal
{
    internal partial class NativeMethods
    {
        ...
        private static readonly string _lockString = string.Intern("e362349b-001d-4cb2-bf55-a71606a3e36f");
        ...
        public static void FORM_OnAfterLoadPage(IntPtr page, IntPtr form)
        {
            lock (_lockString)
            {
        ...
        public static void FORM_DoPageAAction(IntPtr page, IntPtr form, FPDFPAGE_AACTION fPDFPAGE_AACTION)
        {
            lock (_lockString)
            {
                Imports.FORM_DoPageAAction(page, form, fPDFPAGE_AACTION);
            }
        }
        ...
        public static void FORM_OnBeforeClosePage(IntPtr page, IntPtr form)
        {
            lock (_lockString)
            {
        ...
        private static readonly FPDF_SaveBlockDelegate _saveBlockDelegate = _fPDF_SaveBlock;
        ...
        private static int _fPDF_SaveBlock(IntPtr fileWrite, IntPtr data, uint size)
        {
            var write = new FPDF_FILEWRITE();
